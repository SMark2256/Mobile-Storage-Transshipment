...
$SourceStock = 'MEGMSZERSZ-01-01-01';
$Cikk = $_POST['valasztottCikk'];
$Hova = mb_convert_encoding($_POST['valasztottRaktar'] , 'ISO-8859-2', 'WE8PC850');
...
$sql = "INSERT INTO RELUSTOOLSAUT (IK,SYSF,CREATEDATE,CREATEUSER, TOOLSOURCE, ITEMNO, ACTIONTYPE, QUANTITY, FEEDBACKNO, STATUS, SOURCESTOCK, DESTINATIONSTOCK, COMMENT0) VALUES (INFOR.MM_NEXT_IK(),'0000087665',SYSDATE,'PHP', 'SZERSZAUT1','".$Cikk."','".$Muvelet."','".$Mennyit."','".$VJSZ."','0','".$SourceStock."', '".$HovaDE."','PHP TESZT')";
...
Echo '  <li class="list-group-item">Hova: '.$_POST['valasztottRaktar'].'-'.$_POST['cikkHovaXYZ'].'</li>';
...
header('Refresh: 2; URL=https://intranet2/testing/raktarozo/index.php');
