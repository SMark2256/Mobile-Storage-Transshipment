...
<body>
      ...
      <div id="formContainer" class="container bg-light">
            <form onsubmit="return submitAlert();" method="post" action="insert.php">
                  <div class="row col-md-12">
                        <div class="col-md-6">
                              <label for="cikkek" class=" form-label unselectable">Milyen cikket mozgassunk?(MEGMSZERSZ)</label>
                              <select id="cikkek" name="cikkek" class="form-control sel form-select" onchange="cikkekChange()" required>
                        ...
                        <div class="col-md-6 ">
                              ...
                              <div id="muvelet" class="col-md-12 btn-group">
                                    <div class="col-md-4">
                                          <input type="radio" class="btn-check" name="cikkmuvelet" id="btnradio1" value="Athelyez" autocomplete="off" checked
                                                onclick="VjszOnOff(0)">
                                          <label class="btn btn-outline-primary col-md-11 form-label" for="btnradio1">Áthelyez</label>
                                    </div>

                                    <div class="col-md-4">
                                          <input type="radio" class="btn-check " name="cikkmuvelet" id="btnradio2" value="Sztorno" autocomplete="off"
                                                onclick="VjszOnOff(1)">
                                          <label class="btn btn-outline-primary col-md-11 form-label" for="btnradio2">Sztornó</label>
                                    </div>

                                    <div class="col-md-4">
                                          <input type="radio" class="btn-check " name="cikkmuvelet" id="btnradio3" value="Anyagkiir" autocomplete="off"
                                                onclick="VjszOnOff(1)">
                                          <label class="btn btn-outline-primary col-md-11 form-label" for="btnradio3">Anyagkiírás</label>
                                    </div>
                              </div>
                        </div>
                  </div>
                  ...
                  <div class="row col-md-12">
                        <div class="col-md-4">
                              <label for="forrasRaktar" class="label-form unselectable">Forrás Raktár</label>
                        ...
                        <div class="col-md-4">
                        <label for="cikkHova" class="label-form unselectable">Cél Raktár</label>
                        ...
                        <div class="col-md-4">
                        <label for="cikkHovaXYZ" class="label-form unselectable">Cél Raktár Koordináta</label>
                  ...
                  <div class="row col-md-12">
                        ...
                        <div class="col-md-3">
                              <label for="vjsz" class="unselectable">VJSZ:</label>
                              <input id="vjsz" name="vjsz" type="text" class="form-control" autocomplete="off" />
                        </div>

                        <div class="col-md-3">
                              <label for="mennyRange" class="form-label">Mennyiség:
                                    <textarea readonly id="mennyRangeSzam" class="bg-light">
                                    </textarea>
                              </label>
                              <input type="range" class=" form-range " min="0" max="100" id="mennyRange" name="mennyRange" oninput="mennyRangeChange()" />
                        </div>
                  </div>
      ...
      <footer class="page-footer fixed-bottom">
            <div class="footer-copyright bg-light text-center py-2">© 2022 Copyright:
